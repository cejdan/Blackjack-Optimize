...
while leftCasino == False:
    ...
    while handComplete == False:
        ...
        if (myGame.calculateHand(playerHand) == 21):
            ...
            #Resolve the Dealer. If they get a 21, you push. If they fail to get a blackjack, you win! Casino pays 1.5x on natural blackjacks, 1x otherwise
        ...
        if (player_choice.isalpha()):
            ...
            if (player_choice == "Stand" or player_choice == "stand"):
                ...
                #Sometimes the dealer starts with >17
                if(myGame.calculateHand(dealerHand) >= 17 and myGame.calculateHand(dealerHand) <= 21):
                    dealerUnder17 = False
                    dealerHand = myGame.stand(dealerHand)
                    print("The dealer stands.")
                        
                    if (myGame.calculateHand(dealerHand) > myGame.calculateHand(playerHand)):
                        print ("So sorry, the dealer wins. You lost ", wager, "chips.")
                        playerChips = playerChips - wager
                    elif (myGame.calculateHand(dealerHand) == myGame.calculateHand(playerHand)):
                ...
                #Loop until the dealer is better than 17 or bust.
                while dealerUnder17 == True:
                    myGame.hit(dealerHand)
                    print("The dealer hits.")
                    
                    if(myGame.calculateHand(dealerHand) > 21):
                        dealerUnder17 = False
                        print("The dealer shows:")
                        print(dealerHand)
                        print ("The dealer busts! You win", wager, "chips!")
                        playerChips = playerChips + wager
                        break
                    ...
                    print("The dealer shows:")
                    print(dealerHand)
                    print("The dealer is under 17, they must hit.")
            ...
            if (player_choice == "Double" or player_choice == "double" and len(playerHand) == 2):
                ...
                playerHand = myGame.hit(playerHand)
                #Need to resolve the game here, no more options exist for the player. Do all automated Dealer actions now.
                #Decide if you won or lost.
                handComplete = True
            
            if (player_choice == "Surrender" or player_choice == "surrender"):
                wager = int(wager / 2)
                playerChips = playerChips - wager
                #Need to resolve the game here, but you lose no matter what.
                handComplete = True
